      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-16 w-full max-w-6xl relative z-10">
        ...
        <button
          ...
          className={`
            ...
            hover:border-blue-400/50 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)]
        ...
        >
          <div className={`w-24 h-24 rounded-3xl flex items-center justify-center mb-8 transition-all duration-300 group-hover:scale-110 ${accessibility.highContrast ? 'bg-white' : 'bg-blue-100 dark:bg-blue-900/30'}`}>
        ...
        <button
          ...
          className={`
            ${buttonSizeClass} group glass-card relative flex flex-col items-center justify-center p-8 text-center
            hover:border-emerald-400/50 hover:shadow-[0_0_30px_rgba(16,185,129,0.15)]
            hover:-translate-y-2 transition-all duration-300
            ${accessibility.highContrast ? 'bg-black border-4 border-yellow-400' : ''}
          `}
          aria-label="Speech to Sign Language - I am Hearing"
        >
          <div className={`w-24 h-24 rounded-3xl flex items-center justify-center mb-8 transition-all duration-300 group-hover:scale-110 ${accessibility.highContrast ? 'bg-white' : 'bg-emerald-100 dark:bg-emerald-900/30'}`}>
